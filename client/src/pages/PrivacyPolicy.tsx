          ...
          >
            ...
            <div className="space-y-8 text-gray-200">
              <section>
                ...
                <p className="mb-3">
                  Niniejsza polityka dotyczy Serwisu www, funkcjonującego pod adresem url: codelinesjs.pl
                </p>
                <p className="mb-3">
                  Operatorem serwisu oraz Administratorem danych osobowych jest: Oliwier Markieiwcz 98-200, Sieradz
                </p>
                <p className="mb-3">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-js mb-4">2. Wybrane metody ochrony danych stosowane przez Operatora</h2>
                <ul className="list-disc pl-6 space-y-2">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-js mb-4">4. Twoje prawa i dodatkowe informacje o sposobie wykorzystania danych</h2>
                <p className="mb-3">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-js mb-4">5. Informacje w formularzach</h2>
                <ul className="list-disc pl-6 space-y-2">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-js mb-4">7. Istotne techniki marketingowe</h2>
                <ul className="list-disc pl-6 space-y-2">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-js mb-4">8. Informacja o plikach cookies</h2>
                <ul className="list-disc pl-6 space-y-2">
              ...
              <section>
                <h2 className="text-2xl font-semibold text-js mb-4">9. Zarządzanie plikami cookies – jak w praktyce wyrażać i cofać zgodę?</h2>
                <p className="mb-3">
                ...
                <ul className="list-disc pl-6 space-y-1">
                  <li><a href="#" className="text-js hover:underline">Edge</a></li>
                  <li><a href="#" className="text-js hover:underline">Internet Explorer</a></li>
                  <li><a href="#" className="text-js hover:underline">Chrome</a></li>
                  <li><a href="#" className="text-js hover:underline">Safari</a></li>
                  <li><a href="#" className="text-js hover:underline">Firefox</a></li>
                  <li><a href="#" className="text-js hover:underline">Opera</a></li>
                </ul>
                <p className="mt-3 mb-2">Urządzenia mobilne:</p>
                <ul className="list-disc pl-6 space-y-1">
                  <li><a href="#" className="text-js hover:underline">Android</a></li>
                  <li><a href="#" className="text-js hover:underline">Safari (iOS)</a></li>
                  <li><a href="#" className="text-js hover:underline">Windows Phone</a></li>
                </ul>
              </section>
