...
const LoadingSpinner = lazy(() => import('../UI/LoadingSpinner/LoadingSpinner.component').then(module => ({ default: module.LoadingSpinner })));
    ...
    <ErrorBoundary fallback={
      ...
      <main className="bg-gradient-to-b from-dark via-dark-medium to-dark backdrop-blur-lg flex min-h-screen">
        <Helmet>
          ...
          <meta name="description" content="Panel użytkownika CodeLinesJS - dostęp do kursów, gier i statystyk nauki." />
        </Helmet>
