...
export const DashboardContent = memo(() => {
  ...
  return (
    <motion.div
      ...
      animate="visible"
    >
      <motion.h1 className={`${styles.text.heading} text-3xl mb-12`} variants={animations.item}>
        Dashboard
      </motion.h1>

      <div className={styles.grid}>
        <motion.div variants={animations.item} className={styles.card.community}>
          <CommunityBlock />
        </motion.div>

        <motion.div variants={animations.item} className={styles.card.game}>
          <GameBlock />
        </motion.div>

        <motion.div variants={animations.item} className={styles.card.stats}>
