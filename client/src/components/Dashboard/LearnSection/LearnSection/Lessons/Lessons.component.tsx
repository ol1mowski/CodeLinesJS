...
export const Lessons = memo(() => {
  ...
  const { filteredLessons, filter, setFilter, isLoading, error, refetch, isEmpty, userProgress } =
    useLessons();
  ...
  if (error) {
    return <ErrorMessage message="Nie udało się pobrać listy lekcji. Spróbuj ponownie później." />;
  }
  ...
  if (isEmpty) {
    return (
      <div className="flex flex-col items-center justify-center py-12 text-center">
        ...
        <h3 className="text-xl font-bold text-js mb-2">Brak dostępnych lekcji</h3>
    ...
    return (
      <div className="flex flex-col items-center justify-center py-12 text-center">
        ...
        <p className="text-gray-400 text-sm max-w-md">
          W tej kategorii nie znaleziono żadnych lekcji. Możesz wybrać inny poziom trudności lub
          <button
        ...
        <div className="mt-8">
          <LessonsFilter onFilterChange={handleFilterChange} className="justify-center" />
        </div>
      </div>
    );
  }
