    ...
    return (
      ...
      >
        ...
        <div className="mb-4 p-5">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-3">
              ...
              <div className="text-sm text-gray-400">
                {currentChallenge.category === 'syntax'
                  ? 'Błąd składni'
                  : currentChallenge.category === 'naming'
                    ? 'Błąd nazewnictwa'
                    : 'Błąd logiki'}
              </div>
            </div>
          ...
          <p className="mt-1 text-gray-500 text-sm">Pozostałe próby: {MAX_ATTEMPTS - attempts}</p>
        </div>
        ...
        <JSTypoHunterHint hint={currentChallenge.hint || ''} isVisible={attempts > 0} />
      </motion.div>
    );
  }
);
