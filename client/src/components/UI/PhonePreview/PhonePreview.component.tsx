      ...
      {isAbsolute && (
        <>
          <div 
            ...
            style={{ [glowPositions.top.right ? 'right' : 'left']: glowPositions.top.right || glowPositions.top.left }}
          ></div>
          <div 
            className="absolute bottom-1/3 w-16 h-16 bg-[#f7df1e]/20 rounded-full blur-xl"
            style={{ [glowPositions.bottom.right ? 'right' : 'left']: glowPositions.bottom.right || glowPositions.bottom.left }}
          ></div>
        </>
      )}
    </div>
