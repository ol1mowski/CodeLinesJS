...
export const LevelUpNotification = memo(
  ({ level, rewards, onClose, isVisible }: LevelUpNotificationProps) => (
    <AnimatePresence>
      {isVisible && (
        <motion.div
        ...
        >
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h3 className="text-js font-bold text-lg">Nowy Poziom!</h3>
              <p className="text-gray-400">Osiągnięto poziom {level}</p>
            </div>
          </div>
