...
export const StatCard = memo(
  ({ icon: Icon, label, mainValue, subValue, trend, details, index }: StatCardProps) => {
      ...
      <>
        ...
        <div className="mb-3">
          ...
          <div className="flex flex-col">
            <span className="text-3xl font-bold text-js">{mainValue}</span>
            <span className="text-sm text-gray-500 mt-1">{subValue}</span>
          </div>
        </div>
