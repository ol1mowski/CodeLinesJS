...
export const ChatInput = memo(({ displayedText, cursorVisible, isTypingResponse }: ChatInputProps) => (
  <div className="flex gap-3">
    <div className="flex-1 bg-dark/50 border border-js/20 rounded-lg px-4 py-2 
