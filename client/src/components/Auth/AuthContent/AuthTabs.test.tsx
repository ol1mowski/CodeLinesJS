...
describe('AuthTabs', () => {
  ...
  it('renders all tabs correctly', () => {
    ...
    const { container } = render(<AuthTabs activeTab="login" onTabChange={mockOnTabChange} />);
  ...
  it('highlights the active tab correctly', () => {
    ...
    const { container } = render(<AuthTabs activeTab="register" onTabChange={mockOnTabChange} />);
