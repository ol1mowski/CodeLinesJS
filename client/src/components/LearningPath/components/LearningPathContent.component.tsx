      ...
      <div className="relative pt-16 md:pt-24 lg:pt-20">
        ...
        >
          <div className="relative w-[220px] md:w-[240px] lg:w-[260px]">
            ...
            >
              ...
              <div className="w-full h-full bg-gradient-to-br from-[#2a2a2a] to-[#1a1a1a] flex items-center justify-center">
                <div className="text-center p-4">
                  ...
                  <h4 className="text-white font-bold mb-1 text-sm">Teoria JavaScript</h4>
            ...
            <div className="absolute top-1/3 -right-5 w-16 h-16 bg-[#f7df1e]/20 rounded-full blur-xl"></div>
            <div className="absolute bottom-1/3 -left-5 w-16 h-16 bg-[#f7df1e]/20 rounded-full blur-xl"></div>
          </div>
        </motion.div>
