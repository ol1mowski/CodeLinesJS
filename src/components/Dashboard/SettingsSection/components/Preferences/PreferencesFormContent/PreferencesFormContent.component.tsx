...
import { NotificationsSection } from '../../../SettingsContent/PreferencesForm/components/NotificationsSection/NotificationsSection.component';
import { LanguageSection } from '../../../SettingsContent/PreferencesForm/components/LanguageSection/LanguageSection.component';
  ...
  >
    <div className="bg-dark/30 backdrop-blur-sm rounded-xl p-4 sm:p-6 md:p-8 border border-js/10 space-y-6">
      <NotificationsSection 
        register={register} 
        values={formValues}
        onChange={(field: keyof PreferencesData, value: boolean) => setValue(field, value)}
      />
